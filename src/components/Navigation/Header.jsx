...
function Header() {
  return (
    <header className="header">
      <section id="home" />
      <div className="h-screen flex flex-col justify-around items-center gap-4 m-2.5 border-2 border-gray-200 rounded-lg bg-[url('/Background.webp')] bg-fixed animate-gradient">
        {[
