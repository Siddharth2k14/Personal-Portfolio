...
function Projects() {
  return (
    <section id="projects" className="p-10 m-2.5 bg-[url('https://res.cloudinary.com/dhgojtmbf/image/upload/v1772386850/Background_rzyxms.avif')] bg-fixed animate-gradient text-center border-2 border-gray-100">
